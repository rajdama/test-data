...
// node_modules/.pnpm/@ai-sdk+provider-utils@2.2.7_zod@3.25.67/node_modules/@ai-sdk/provider-utils/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+openai@1.3.21_zod@3.25.67/node_modules/@ai-sdk/openai/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+anthropic@1.2.10_zod@3.25.67/node_modules/@ai-sdk/anthropic/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+google@1.2.14_zod@3.25.67/node_modules/@ai-sdk/google/dist/index.mjs
...
var safetyRatingSchema = import_zod14.z.object({
  category: import_zod14.z.string(),
  probability: import_zod14.z.string(),
...
// node_modules/.pnpm/@ai-sdk+openai-compatible@0.2.13_zod@3.25.67/node_modules/@ai-sdk/openai-compatible/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+xai@1.2.15_zod@3.25.67/node_modules/@ai-sdk/xai/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+openai@1.3.21_zod@3.25.67/node_modules/@ai-sdk/openai/internal/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+azure@1.3.22_zod@3.25.67/node_modules/@ai-sdk/azure/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+groq@1.2.8_zod@3.25.67/node_modules/@ai-sdk/groq/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+cerebras@0.2.13_zod@3.25.67/node_modules/@ai-sdk/cerebras/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+togetherai@0.2.13_zod@3.25.67/node_modules/@ai-sdk/togetherai/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+mistral@1.2.7_zod@3.25.67/node_modules/@ai-sdk/mistral/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+deepseek@0.2.13_zod@3.25.67/node_modules/@ai-sdk/deepseek/dist/index.mjs
...
// node_modules/.pnpm/@ai-sdk+perplexity@1.1.8_zod@3.25.67/node_modules/@ai-sdk/perplexity/dist/index.mjs
      ...
      try {
        ...
        if (this.tools && Object.keys(this.tools).length > 0) {
          const customTools = Object.entries(this.tools).map(([name14, tool11]) => {
            let inputSchema = tool11.parameters;
          ...
          case "keypress": {
            ...
            if (Array.isArray(keys)) {
              for (const key of keys) {
                ...
                yield this.page.keyboard.press(mappedKey);
              }
            }
            return { success: true };
          }
...
var createGotoTool = (stagehandPage) => (0, import_ai3.tool)({
  ...
  execute: (_0) => __async(null, [_0], function* ({ url }) {
    try {
      yield stagehandPage.page.goto(url, { waitUntil: "load" });
...
var createActTool = (stagehandPage, executionModel) => (0, import_ai4.tool)({
  description: "Perform an action on the page (click, type)",
  parameters: import_v36.z.object({
    action: import_v36.z.string().describe(`Describe what to click, or type within in a short, specific phrase that mentions the element type. 
          Examples:
  ...
  execute: (_0) => __async(null, [_0], function* ({ action }) {
    try {
      ...
      const observeResults = yield stagehandPage.page.observe(observeOptions);
      ...
      if (isIframeAction) {
        ...
        const iframeObserveResults = yield stagehandPage.page.observe(iframeObserveOptions);
        ...
        const fallback = yield stagehandPage.page.act(iframeObserveResult);
        return {
      ...
      const result = yield stagehandPage.page.act(observeResult);
...
var createScreenshotTool = (stagehandPage) => (0, import_ai5.tool)({
  ...
  execute: () => __async(null, null, function* () {
    const screenshotBuffer = yield stagehandPage.page.screenshot({
      fullPage: false,
      type: "jpeg"
    });
...
var createAriaTreeTool = (stagehandPage) => (0, import_ai9.tool)({
  ...
  execute: () => __async(null, null, function* () {
    const { page_text } = yield stagehandPage.page.extract();
    const pageUrl = stagehandPage.page.url();
...
var createFillFormTool = (stagehandPage, executionModel) => (0, import_ai10.tool)({
 ...
 `,
  ...
  execute: (_0) => __async(null, [_0], function* ({ fields }) {
    ...
    const observeResults = executionModel ? yield stagehandPage.page.observe({
      instruction,
      modelName: executionModel
    }) : yield stagehandPage.page.observe(instruction);
    const completedActions = [];
    for (const result of observeResults) {
      const action = yield stagehandPage.page.act(result);
...
var createScrollTool = (stagehandPage) => (0, import_ai11.tool)({
  ...
  execute: (_0) => __async(null, [_0], function* ({ pixels, direction }) {
    yield stagehandPage.page.mouse.wheel(
      0,
...
var createExtractTool = (stagehandPage, executionModel, logger) => (0, import_ai12.tool)({
  ...
  execute: (_0) => __async(null, [_0], function* ({ instruction, schema }) {
    try {
      ...
      const result = yield stagehandPage.page.extract(__spreadValues({
        instruction,
        schema: schemaObject
...
function createAgentTools(stagehandPage, options) {
  ...
  return {
    ...
    extract: createExtractTool(stagehandPage, executionModel, options == null ? void 0 : options.logger),
...
var StagehandAgentHandler = class {
  constructor(stagehandPage, logger, llmClient, executionModel, systemInstructions, mcpTools) {
    this.stagehandPage = stagehandPage;
    this.logger = logger;
    this.llmClient = llmClient;
...
var Stagehand3 = class {
  ...
  set page(newPage) {
    if (!this.stagehandContext) {
      throw new StagehandNotInitializedError("page setter");
    }
    const shPage = this.stagehandContext.getExistingStagehandPage(
      newPage
    );
    if (shPage) {
      this.setActivePage(shPage);
      this._livePageProxy = this.createLivePageProxy();
    } else {
      this.logger({
        category: "page",
        message: "Warning: attempted to set a page that was not initialized with Stagehand. It will be initialized now.",
        level: 1
      });
      this.stagehandContext.getStagehandPage(newPage).then((stagehandPage) => {
        this.setActivePage(stagehandPage);
        this._livePageProxy = this.createLivePageProxy();
      });
    }
    ...
    if (!options || !options.provider) {
      ...
      return {
        execute: (instructionOrOptions) => __async(this, null, function* () {
          ...
          if (this.usingAPI) {
            const agentConfigForApi = options;
            return yield this.apiClient.agentExecute(
              agentConfigForApi,
              executeOptions
            );
          }
          const tools = (options == null ? void 0 : options.integrations) ? yield resolveTools(options == null ? void 0 : options.integrations, options == null ? void 0 : options.tools) : (_a15 = options == null ? void 0 : options.tools) != null ? _a15 : {};
      ...
      execute: (instructionOrOptions) => __async(this, null, function* () {
        ...
        const agentHandler = new CuaAgentHandler(
          ...
          this.logger,
          {
            ...
            userProvidedInstructions: (_b = options.instructions) != null ? _b : `You are a helpful assistant that can use a web browser.
