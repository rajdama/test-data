...
type PlaywrightPage = Page$1;
interface Page extends Omit<PlaywrightPage, "on" | "screenshot"> {
...
declare class StagehandContext {
    ...
    getExistingStagehandPage(page: Page$1): StagehandPage | undefined;
