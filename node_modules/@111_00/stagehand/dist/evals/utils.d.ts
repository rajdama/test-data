...
export declare function sampleUniform<T>(arr: T[], k: number): T[];
export declare function readJsonlFile(filePath: string): string[];
export declare function parseJsonlRows<T>(lines: string[], validator: (parsed: unknown) => parsed is T): T[];
export declare function applySampling<T>(candidates: T[], sampleCount?: number, maxCases?: number): T[];
